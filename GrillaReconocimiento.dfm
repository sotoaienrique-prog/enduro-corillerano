object GrillaReconocimientoForm: TGrillaReconocimientoForm
  Left = 0
  Top = 0
  ...
  object GrillaReconocimientoForm: TPanel
    Left = 0
    Top = 99
    Width = 989
    Height = 393
    ...
    object cxGridPosiciones: TcxGrid
      ...
      object cxGridPosicionesDBTableView: TcxGridDBTableView
        DataController.DataSource = DSReconocimiento
        ...
        object cxGridPosicionesDBTableViewcategoria1: TcxGridDBColumn
          Caption = 'Categor'#237'a'
          DataBinding.FieldName = 'categoria'
          Width = 206
        end
        object cxGridPosicionesDBTableViewtiempo: TcxGridDBColumn
          Caption = 'Tiempo'
          DataBinding.FieldName = 'tiempo'
          Width = 199
        end
        object cxGridPosicionesDBTableViewtiempo_pasada: TcxGridDBColumn
          Caption = 'Hora Pasada'
          DataBinding.FieldName = 'tiempo_pasada'
          Width = 168
        end
        object cxGridPosicionesDBTableViewnro_vuelta: TcxGridDBColumn
          Caption = 'N'#250'mero de Vuelta'
  ...
  object ZROQReconocimiento: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'where tt.toma_tiempo_evento_oid =:toma_tiempo_evento_oid'
        ...
        '     and (:categoria_oid is null or :categoria_oid = 0 or :categ' +
        'oria_oid = sel_categoria_oid_by_evento_and_tipo_categoria(ipe.ti' +
        'po_categoria_oid, tte.evento_oid, ipe.piloto_oid)) '
      
        '      and TIME_TO_SEC(TIMEDIFF(current_timestamp , tt.tiempo_pas' +
        'ada)) < (:tiempo_espera)'
      '     and tt.is_deleted = 0'
      'order by tt.oid desc'
  ...
  object DSReconocimiento: TDataSource
    DataSet = ZROQReconocimiento
    Left = 376
    Top = 392
  end
  ...
  object JvTimerCategorias: TJvTimer
    Enabled = False
    Interval = 15000
    OnTimer = JvTimerCategoriasTimer
    Left = 456
    Top = 224
  end
  object ZROQReconocimientoCount: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'where tt.toma_tiempo_evento_oid =:toma_tiempo_evento_oid'
        ...
        '      and TIME_TO_SEC(TIMEDIFF(current_timestamp , tt.tiempo_pas' +
        'ada)) < (:tiempo_espera + :tiempo_permanencia)'
      '     and tt.is_deleted = 0'
      'order by tt.oid desc')
    Params = <
      item
