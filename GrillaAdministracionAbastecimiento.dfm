object TAdminGillaAbastecimiento: TTAdminGillaAbastecimiento
  Left = 0
  Top = 0
  Caption = 'Administracion de Abastecimiento'
  ClientHeight = 448
  ClientWidth = 912
  Color = clBtnFace
  ...
  object PanelTop: TPanel
    ...
    object cmbFilterEvento: TDBLookupComboBox
      ...
      ParentFont = False
      TabOrder = 1
      OnCloseUp = cmbFilterEventoCloseUp
      ExplicitWidth = 316
    end
  end
  object mainPanel: TPanel
    ...
    object cxGridPosiciones: TcxGrid
      ...
      object cxGridPosicionesDBTableView: TcxGridDBTableView
        ...
        object cxGridPosicionesDBTableViewnumero: TcxGridDBColumn
          Caption = 'N'#250'mero'
          DataBinding.FieldName = 'numero'
          Width = 73
        end
        object cxGridPosicionesDBTableViewnombre_apellido: TcxGridDBColumn
          Caption = 'Competidor'
          DataBinding.FieldName = 'nombre_apellido'
          Width = 203
        end
  ...
  object ZROQPosiciones: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'select pimp.numero, pimp.nombre_apellido, pimp.categoria, tta.ti' +
        'empo_pasada, tta.nro_vuelta, tta.oid'
      'from toma_tiempo_abastecimiento tta'
      
        '     inner join piloto_importado pimp on tta.piloto_importado_oi' +
        'd = pimp.oid'
