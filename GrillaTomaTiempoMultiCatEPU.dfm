object GrillaTomaTiempoMultiCatEPUForm: TGrillaTomaTiempoMultiCatEPUForm
  Left = 0
  Top = 0
  ...
  object topPanel: TPanel
    ...
    object chkAgruparPorKMs: TcxCheckBox
      Left = 481
      Top = 70
      Caption = 'Agrupar por KM'
      ParentFont = False
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -12
    ...
    object chkAgruparPorSexo: TcxCheckBox
      Left = 481
      Top = 86
      Caption = 'Agrupar por Sexo'
      ParentFont = False
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -12
  ...
  object ZROQPosiciones1: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      ' where tte.oid = :toma_tiempo_evento_oid'
        ...
        'ategoria_oid, tte.evento_oid, ipe.piloto_oid)) in (:categoria_oi' +
        'd)'
      ' group by p.oid '
