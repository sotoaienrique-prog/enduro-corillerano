inherited InscripcionesCRUD: TInscripcionesCRUD
      ...
      inherited cxGrid: TcxGrid
        ...
        inherited cxGridDBTableView: TcxGridDBTableView
          ...
          object cxGridDBTableViewCategoria: TcxGridDBColumn
            Caption = 'Categor'#237'a'
            DataBinding.FieldName = 'nombres_categoria'
            Width = 53
          end
          ...
          object cxGridDBTableViewColumn1: TcxGridDBColumn
            Caption = 'Tiene Inscripcion'
            DataBinding.FieldName = 'tiene_inscripcion_campeonato'
            Width = 20
          end
    ...
    inherited topPanel: TPanel
      ...
      inherited editorPanel: TPanel
        ...
        object usgusta: TAeroButton
          ...
          Spacing = 10
          Version = '1.0.0.1'
          Caption = 'Inscribir por XLS'
          TabOrder = 11
          OnClick = usgustaClick
        end
        object btnDesinscripcionMasiva: TAeroButton
          AlignWithMargins = True
          Left = 623
          Top = 26
          Width = 152
          ...
          Spacing = 6
          Version = '1.0.0.1'
          Caption = 'Desinscripci'#243'n Masiva'
          TabOrder = 12
          OnClick = btnDesinscripcionMasivaClick
        end
      end
  ...
  inherited queryGrid: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      '    MAX(sub.oid) AS oid,'
      '    sub.piloto_oid,'
      '    MAX(sub.nombre_evento) AS nombre_evento,'
      '    sub.nombre_pilot,'
      '    sub.nombre_piloto,'
      '    MAX(sub.nombre_campeonato) AS nombre_campeonato,'
      '    sub.evento_oid,'
      
        '    GROUP_CONCAT(DISTINCT sub.nro_moto SEPARATOR '#39' / '#39') AS nro_m' +
        'oto,'
      
        '    GROUP_CONCAT(DISTINCT sub.nombre_categoria SEPARATOR '#39' / '#39') ' +
        'AS nombres_categoria,'
      
        '    GROUP_CONCAT(DISTINCT sub.tipo_categoria SEPARATOR '#39' / '#39') AS' +
        ' tipo_categoria,'
      
        '    GROUP_CONCAT(DISTINCT sub.tipo_categoria_oid SEPARATOR '#39' / '#39 +
        ') AS tipo_categoria_oid,'
      '    MAX(sub.evento_oid) evento_oid,'
      '    EXISTS ('
      '        SELECT 1'
      '        FROM inscripcion_piloto_evento ipe2'
      '        INNER JOIN evento e2 ON e2.oid = ipe2.evento_oid'
      '        WHERE e2.campeonato_oid = MAX(sub.campeonato_oid)'
      '          AND ipe2.piloto_oid = sub.piloto_oid'
      '          AND ipe2.evento_oid !=MAX(sub.piloto_oid)'
      '    ) AS tiene_inscripcion_campeonato, sub.tid'
      'FROM ('
      '    SELECT '
      '        ipe.piloto_oid,'
      '        ipe.oid,'
      
        '        sel_nro_moto_by_evento_and_tipo_categoria(ipe.tipo_categ' +
        'oria_oid, ipe.evento_oid, p.oid) as nro_moto,'
      '        ipe.evento_oid,'
      '        ipe.tipo_categoria_oid,'
      '        CONCAT(p.apellido, '#39', '#39' , p.nombre) nombre_pilot,  '
      
        '        CASE WHEN cat.utiliza_acompaniante = 1 THEN CONCAT(UC_Wo' +
        'rds(CONCAT(p.apellido, '#39', '#39' , p.nombre)), IFNULL(UC_Words(CONCAT' +
        '('#39' / '#39', n.apellido, '#39', '#39' , n.nombre)), '#39#39')) '
      '            ELSE UC_Words(CONCAT(p.apellido, '#39', '#39' , p.nombre))'
      '       end as nombre_piloto,     '
      
        '        CONCAT(e.nro_fecha, '#39' - '#39', DATE_FORMAT(e.fecha,  '#39'%d/%m/' +
        '%Y'#39'), '#39' - '#39', e.nombre) nombre_evento,'
      '        c.nombre as nombre_campeonato,'
      '        c.oid as campeonato_oid,'
      
        '        sel_nombre_categoria_by_evento_and_tipo_categoria(ipe.ti' +
        'po_categoria_oid, ipe.evento_oid, p.oid) as nombre_categoria,'
      '        tc.nombre tipo_categoria, p.tid'
  ...
  inherited ilMain: TImageList
    Bitmap = {
      494C010137003B00100210001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object ZExportarInscripcion: TZQuery
    ...
    SQL.Strings = (
      ...
      ' IFNULL(cat_ext.nombre, '#39#39') as '#39'Categor'#237'a Externa'#39', '
      ...
      '     left join modelo_moto mm on p.modelo_moto_oid = mm.oid'
        ...
        '     left join categorias cat_ext on cat_ext.oid = p.categoria_e' +
        'xterna_oid          '
      '     join evento e on ipe.evento_oid = e.oid,'
      '     categorias cat'
  ...
  object usuarioDBDS: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'ranking=ranking'
      'num_moto_cross_backup=num_moto_cross_backup'
      'piloto=piloto'
  ...
  object ZDesinscripcionMasiva: TZQuery
    Connection = ConnectionModule.ZConnection
    SQL.Strings = (
      
        'delete from inscripcion_piloto_evento where evento_oid = :evento' +
        '_oid;')
    Params = <
      item
        DataType = ftUnknown
  ...
  object frxInscripcionReporte: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 46197.771725046300000000
    ReportOptions.LastChange = 46197.771725046300000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
